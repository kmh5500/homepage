...
<FORM name='frm' method='POST' action='./list.jsp'>
  ...
  <button>검색</button>
  <button onclick="location.href='<%=root %>/member/createForm.jsp'">회원가입</button>
  </FORM>
  </div>
 ...
 %>
  <TABLE class="table table-hover">
    <TR>
    	<td rowspan="5" style="width: 20%"><img src='<%=root %>/member/storage/<%=dto.getFname()%>' width="200px" heigh="200px"> </td>
