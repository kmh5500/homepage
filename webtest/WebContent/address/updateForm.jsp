...
<div class="title">주소 등록</div>
<form action="./updateProc.jsp" method="post" onsubmit="return incheck(this)">
...
<button type="button" onclick="alist()">목록</button>
<input type="button" onclick="alist()" value ="목록">
