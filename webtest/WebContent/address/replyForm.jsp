...
<jsp:useBean id="dao" class="address.addressDAO"></jsp:useBean>
<% 
...
<div  class="title">답변 주소 등록</div>
<form action="./replyProc.jsp" method="post" onsubmit="return incheck(this)">
...
<button onclick="aliste()">목록</button>
</div>
</form>
