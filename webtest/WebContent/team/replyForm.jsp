...
<div class="title">답변 등록</div>
<form name ="ftm" action="./replyProc.jsp" method="post" onsubmit="return incheck(this)">
...
<!-- 	<caption>팀정보 등록</caption> -->
	<tr>
		<th>이름</th>
		<td><input type="text" name="name" value <%=dto.getName()%>size="25" ></td>
	</tr>
	<tr>
		<th>성별</th>
		<td>
