...
<div class="container">
  ...
  <input type="hidden" name="nowPage" value="${param.nowPage}">
    ...
    <div class="form-group">
      ...
      <textarea rows="10" cols="" class="form-control" id="content" name="content" required="required" >${dto.content}</textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" id="file"   placeholder="Enter file" name="filenameMF" value="${dto.filename}">
